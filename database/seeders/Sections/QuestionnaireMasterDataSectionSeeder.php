...
class QuestionnaireMasterDataSectionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $mainSection->fill([
            ...
            'description' => <<<'MD'
يضم هذا القسم البيانات والكيانات المرجعية التي يجب تأسيسها مبكرًا حتى تعتمد عليها بقية أجزاء النظام بصورة موحدة، مثل هيكل المزرعة وأنشطتها والسلالات وفريق التشغيل وقوائم الأسباب التشغيلية وبيانات الموقع.
MD,
            'sort_order' => 1,
        ]);
        $mainSection->save();
        ...
        $subsections = [
            [
                'name' => 'بيانات المزرعة',
                'description' => <<<'MD'
تمثل المزرعة أعلى مستوى تنظيمي في النظام، وترتبط بها بيانات الموقع والاتصال والهيكل التشغيلي والإعدادات والقطيع والحركات.
MD,
                'sort_order' => 1,
            ],
            [
                'name' => 'أنشطة المزرعة',
                'description' => <<<'MD'
قائمة مرجعية مستقلة لأنشطة المزرعة، تستخدم لربط المزرعة بنشاط واحد أو أكثر وتوحيد مسميات الأنشطة في الإدخال والتقارير.
MD,
                'sort_order' => 2,
            ],
            [
