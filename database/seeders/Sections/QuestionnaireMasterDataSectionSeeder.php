...
class QuestionnaireMasterDataSectionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $mainSection->fill([
            ...
            'description' => <<<'MD'
يضم هذا القسم البيانات والكيانات المرجعية التي يجب تأسيسها مبكرًا حتى تعتمد عليها بقية أجزاء النظام بصورة موحدة، مثل هيكل المزرعة والموقع والسلالات وفريق التشغيل وقوائم الأسباب التشغيلية.
MD,
            'sort_order' => 1,
        ]);
        $mainSection->save();
