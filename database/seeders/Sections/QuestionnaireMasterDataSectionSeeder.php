...
class QuestionnaireMasterDataSectionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $mainSection->fill([
            ...
            'description' => <<<'MD'
يضم هذا القسم البيانات المرجعية والقوائم المشتركة التي يعاد استخدامها داخل النظام، مثل الأنشطة التشغيلية والأغراض الإنتاجية والسلالات وقوائم الأسباب والمواقع وأنظمة التجهيز. الكيانات الهيكلية الفعلية للمزرعة تدار بصورة مستقلة داخل قسم «هيكل المزرعة».
MD,
            'sort_order' => 1,
        ]);
        $mainSection->save();
