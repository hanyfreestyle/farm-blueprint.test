...
abstract class ReferenceReasonQuestionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $questions = [
            [
                ...
                'help_text' => "حدد البيانات الأساسية التي يجب أن يدعمها {$singular} باعتباره Master Data مرجعية تستخدم لاحقًا في العمليات والتقارير.",
            ...
            [
                ...
                'help_text' => "حدد هل {$plural} تكون قيمًا ثابتة في الكود أم Master Data قابلة للإضافة والتعديل من لوحة التحكم.",
            ...
            [
                ...
                'help_text' => "حدد القيم المبدئية التي يجب إضافتها عند تهيئة النظام. هذا السؤال يخص {$plural} كـMaster Data فقط، أما استخدامها داخل العمليات فيتم حسمه في الأقسام التشغيلية المناسبة.",
                'type' => QuestionType::MULTI_CHOICE,
                'is_required' => true,
                'sort_order' => 6,
