    ...
    public function run(): void
    {
        DB::transaction(function (): void {
            ...
            $questions = [
                ...
                [
                    'seed_key' => 'barn.status_change_requires_inactive_batteries',
                    'title' => 'هل يجب منع تغيير حالة العنبر من «نشط» إلى «متوقف» أو «تحت الصيانة» طالما توجد بطاريات تابعة له ما زالت نشطة تشغيليًا؟',
                    'help_text' => 'إذا كانت الإجابة نعم، يجب أولًا إنهاء تشغيل جميع البطاريات التابعة وجعلها في حالة غير تشغيلية مسموح بها وفق قواعد البطارية قبل السماح بتغيير حالة العنبر. لا يقوم النظام بتغيير حالات البطاريات تلقائيًا عند تغيير حالة العنبر، ويطبق هذا الشرط بالإضافة إلى شرط خلو العنبر من الحيوانات.',
                    'type' => QuestionType::YES_NO,
                    'is_required' => true,
                    'sort_order' => 20,
                    'report_category' => 'workflow_rule',
