...
## 10. القسم السادس المستهدف — الإعدادات وقواعد التشغيل — PARTIALLY APPROVED
...
أي Rule موجود في Master Data أو Farm Structure أو الأقسام الأخرى لا ينتقل إلى Settings تلقائيًا.

### 10.2 6.1 نموذج الإعدادات ونطاق التطبيق — APPROVED

تم اعتماد أول Subsection في القسم السادس باسم:

`نموذج الإعدادات ونطاق التطبيق`

مسؤوليته تعريف Architecture منظومة الإعدادات نفسها، وليس قيم قواعد التلقيح أو الفطام أو السعة أو التنبيهات.
...
### 10.3 ما يجب حسمه بالأسئلة داخل 6.1

لا يفترض مسبقًا أي من التالي:
...
هذه **Open Requirements** تتحول إلى أسئلة ولا تعتمد بالافتراض.

### 10.4 التاريخ وتغيير Settings
...
### 10.5 Evidence من Farm Structure الحالي

أسئلة Barn الحالية تحتوي بالفعل علاقة بـOperational Settings Profile، بينما Battery/Cage تحتوي قواعد تشير إلى Settings في موضوعات مثل:

- التطهير وإعادة الاستخدام.
- أهلية التسكين.
- السعة في بعض النماذج.
- التفعيل في بعض الاختيارات.
- الاحتفاظ بمرجع الإعدادات المستخدمة وقت العملية.
